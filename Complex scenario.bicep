...
param backendThree string = 'backendthree'
param backendFour string = 'backendfour'
...
resource openaibackendthree 'Microsoft.ApiManagement/service/backends@2023-05-01-preview' = {
  name: backendThree
  parent: apim
  properties:{
    url: aoaiThreeUrl
...
resource openaibackendfour 'Microsoft.ApiManagement/service/backends@2023-05-01-preview' = {
  name: backendFour
  parent: apim
  properties:{
    url: aoaiFourUrl
      ...
      services: [
        {
          ...
          weight: 100 // Loadbalance weight. As its racio, doesn't have to be 100 in total
        ...
        {
          id: '/backends/${backendThree}'
          priority: 2 // The lower priority will be used only when higher priority is not available
          weight: 50 // Loadbalance weight. As its racio, doesn't have to be 100 in total
        }
        {
          id: '/backends/${backendFour}'
          priority: 3 // The lower priority will be used only when higher priority is not available
          weight: 100 // Loadbalance weight. As its racio, doesn't have to be 100 in total
        }
      ]
    }
