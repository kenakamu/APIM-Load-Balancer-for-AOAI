...
resource openaibackendtwo 'Microsoft.ApiManagement/service/backends@2023-09-01-preview' = {
  name: backendTwo
  parent: apim
  properties:{
    url: aoaiTwoUrl
...
resource loadbalance 'Microsoft.ApiManagement/service/backends@2023-05-01-preview' = {
  name: loadBalancerId
  parent: apim
  properties: {
